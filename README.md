...
>
> 它**不包含**物品名、方块名、GUI 界面文本、成就等其他内容的翻译。如果你需要这些，请另外搭配 AE2 的官方 / 社区完整汉化使用。
...
> 常见 `pack_format` 对照：1.20.1 → `15`，1.20.2 → `18`，1.20.4 → `22`，1.21.x → `34+`。具体以你所用版本为准。
...
> 提示：确保 AE2 模组已正确安装并加载，否则不会显示指南书。
...
> 本资源包为非官方社区汉化，与 Applied Energistics 2 官方团队无隶属关系。AE2 原始文档及相关内容版权归其各自作者所有。
